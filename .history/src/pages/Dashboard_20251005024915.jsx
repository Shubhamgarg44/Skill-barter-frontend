...
const Dashboard = () => {
  ...
  return (
    // ✅ Full height minus navbar, with top padding for visibility
    <div className="flex bg-slate-950 text-white relative overflow-hidden min-h-[calc(100vh-4rem)] pt-6">
      {/* Background Blobs */}
      ...
      {/* Sidebar */}
      <aside className="w-64 bg-slate-900/60 backdrop-blur-xl p-6 flex flex-col justify-between border-r border-slate-800">
        <div>
