        ...
        <div>
          ...
          <nav className="space-y-4">
            {[
              ...
              { key: "skills", icon: <Briefcase size={18} />, label: "My Skills" },
              { key: "requests", icon: <Handshake size={18} />, label: "Skill Requests" },
              { key: "transactions", icon: <Repeat size={18} />, label: "Transactions" },
  ...
  <div className="space-y-6">
    ...
    <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 shadow-xl flex flex-col md:flex-row justify-between items-center">
      <div className="flex items-center gap-6">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm mt-1">
            Member since: {dayjs(user.createdAt || new Date()).format("MMM YYYY")}
          </p>
        </div>
      </div>
      ...
      <div className="mt-6 md:mt-0 text-center md:text-right">
        ...
        <p className="text-3xl font-bold text-teal-400">💰 {wallet} Tokens</p>
        <p className="text-xs text-gray-500 mt-1">
          Earned: <span className="text-green-400">+{summary.earned}</span> | Spent:{" "}
    ...
    {/* Skills List */}
    <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 shadow-xl">
      <h3 className="text-xl font-semibold text-teal-400 mb-4">My Offered Skills</h3>
      {skills.length > 0 ? (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skills.map((skill) => (
            <div
        ...
        <p className="text-gray-400">You haven’t offered any skills yet.</p>
      )}
    </div>
  </div>
)}
