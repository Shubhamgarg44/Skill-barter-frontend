...
const Dashboard = () => {
  ...
  return (
    <div className="relative flex flex-col bg-slate-950 text-white">
      ...
      {/* ✅ OFFSET for Navbar height (Header) */}
      <div className="pt-[80px] flex flex-1 min-h-screen relative z-10">
        {/* Sidebar */}
        <aside className="w-64 bg-slate-900/70 backdrop-blur-xl p-6 flex flex-col justify-between border-r border-slate-800 h-[calc(100vh-80px)] sticky top-[80px]">
          <div>
        ...
        {/* Main Content */}
        <main className="flex-1 p-10 overflow-y-auto h-[calc(100vh-80px)]">
          {loading ? (
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-slate-900/70 backdrop-blur-xl border border-slate-800 rounded-2xl p-6 shadow-xl">
                    ...
                    <p className="text-gray-400 text-sm mt-2">
                      Use your tokens to request skills from others or offer
                      more to earn!
                    </p>
                  </div>
                </div>
