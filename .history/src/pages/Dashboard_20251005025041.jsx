...
const Dashboard = () => {
  ...
  return (
    <div className="relative bg-slate-950 text-white overflow-hidden">
      ...
      {/* ✅ Main Flex Layout (fills full screen below header) */}
      <div className="flex min-h-[calc(100vh-4rem)] pt-4">
        {/* Sidebar */}
        <aside className="w-64 bg-slate-900/70 backdrop-blur-xl p-6 flex flex-col justify-between border-r border-slate-800">
          <div>
